...
export const embedPositionEnum = pgEnum("embed_position", ["bottom-right", "bottom-left"])
export const embedThemeEnum = pgEnum("embed_theme", ["system", "light", "dark"])
...
export const embed = pgTable(
	...
	(table) => [index("embed_agent_id_idx").on(table.agentId)],
)
