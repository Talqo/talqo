...
export const CHAT_ABSOLUTE_MAX_INPUT_CHARACTERS = 400_000
...
const envSchema = z
	.object({
		...
		TALQO_CHAT_MAX_INPUT_CHARACTERS: positiveSafeInteger
			.max(CHAT_ABSOLUTE_MAX_INPUT_CHARACTERS)
			.default(CHAT_ABSOLUTE_MAX_INPUT_CHARACTERS),
		TALQO_CHAT_MAX_OUTPUT_TOKENS: positiveSafeInteger.default(DEFAULT_CHAT_MAX_OUTPUT_TOKENS),
		TALQO_CHAT_GENERATION_TIMEOUT_SECONDS: positiveSafeInteger.default(DEFAULT_CHAT_GENERATION_TIMEOUT_SECONDS),
