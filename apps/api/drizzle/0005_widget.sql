...
CREATE TABLE "widget" (
	...
	"light_primary_color" text NOT NULL,
	"light_text_on_primary_color" text NOT NULL,
	"light_background_color" text NOT NULL,
	"light_surface_color" text NOT NULL,
	"light_text_color" text NOT NULL,
	"dark_primary_color" text NOT NULL,
	"dark_text_on_primary_color" text NOT NULL,
	"dark_background_color" text NOT NULL,
	"dark_surface_color" text NOT NULL,
