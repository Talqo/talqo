...
>(
	...
	fileName: string,
	options?: {
		query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof downloadAgentFile>>, TError, TData>>
		fetch?: RequestInit
	},
) => {
	const { query: queryOptions, fetch: fetchOptions } = options ?? {}
	...
	return {
		...
		...queryOptions,
	} as UseQueryOptions<Awaited<ReturnType<typeof downloadAgentFile>>, TError, TData> & {
		queryKey: DataTag<QueryKey, TData, TError>
	}
}
...
>(
	...
	options: {
		query: Partial<UseQueryOptions<Awaited<ReturnType<typeof downloadAgentFile>>, TError, TData>> &
			Pick<
				DefinedInitialDataOptions<
					Awaited<ReturnType<typeof downloadAgentFile>>,
					TError,
					Awaited<ReturnType<typeof downloadAgentFile>>
				>,
				"initialData"
