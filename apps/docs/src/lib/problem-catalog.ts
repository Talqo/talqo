...
export const PROBLEMS = [
	...
	},
	{
		...
		status: "400",
		meaning: "Talqo could not derive a trustworthy client network from the connection and configured proxies.",
		guidance: "Correct the trusted proxy configuration and retry.",
	},
	{
		code: "chat-concurrency-limit",
		title: "Chat concurrency limit reached",
		status: "429",
		meaning: "The agent already has the allowed number of active generations for this network.",
		guidance: "Wait for an active response to finish and retry after the indicated delay.",
	},
	{
		code: "chat-context-limit",
		title: "Chat model context limit reached",
		status: "Stream error",
		meaning: "The saved conversation no longer fits the configured model context.",
		guidance: "Start a new conversation.",
	},
	{
		code: "chat-conversation-too-long",
		title: "Chat conversation too long",
		status: "400",
		meaning: "The complete prompt, history, and new message exceed the configured input bound.",
		guidance: "Start a new conversation.",
	},
	{
		code: "chat-daily-allowance-exceeded",
		title: "Chat daily network allowance reached",
		status: "429",
		meaning: "This network has used the daily accepted-question allowance for the agent.",
		guidance: "Retry after the UTC reset time supplied in the response headers.",
	},
	{
		code: "chat-input-incompatible",
		title: "Chat input incompatible with model",
		status: "Stream error",
		meaning: "A fresh prompt and message do not fit the configured model context.",
		guidance: "Shorten the message or correct the agent and model configuration.",
	},
	{
		code: "chat-request-conflict",
		title: "Chat request conflict",
		status: "409",
		meaning: "The request ID was already used with different message text in this session.",
		guidance: "Reuse the original text or send the new text with a new request ID.",
	},
	{
		code: "chat-session-busy",
		title: "Chat session busy",
		status: "429",
		meaning: "This conversation already has an active generation.",
		guidance: "Wait for or cancel the active generation before sending another message.",
	},
	{
		code: "chat-session-unauthorized",
		title: "Chat session unauthorized",
		status: "401",
		meaning: "The bearer credential is missing, invalid, or revoked by an embed lifecycle change.",
		guidance: "Use the private credential issued for this conversation.",
	},
	{
	...
	},
	{
		...
		status: "404",
		meaning: "The requested embed does not exist.",
		guidance: "Refresh the embed list and use an existing ID or token.",
	},
	{
		code: "username-taken",
