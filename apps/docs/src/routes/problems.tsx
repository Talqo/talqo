...
const PROBLEMS = [
	...
	},
	{
		...
		status: "400",
		meaning: "The uploaded file or requested file name violates a file constraint.",
		guidance: "Use an allowed file type, size, and name.",
	},
	{
		code: "agent-file-name-taken",
		title: "Agent file name already in use",
		status: "409",
		meaning: "Another file for this agent uses the requested name.",
		guidance: "Choose a unique file name.",
	},
	{
		code: "agent-file-not-found",
		title: "Agent file not found",
		status: "404",
		meaning: "The requested file does not exist for this agent.",
	...
	},
	{
		...
		title: "Agent in use",
		status: "409",
		meaning: "One or more widgets still use the requested agent.",
		guidance: "Delete or reassign those widgets before deleting the agent.",
	},
	{
	...
	},
	{
		...
		status: "413",
		meaning: "The request body exceeds Talqo's transport limit.",
		guidance: "Reduce the request body size and retry.",
	},
	{
	...
	},
	{
		...
		status: "404",
		meaning: "The requested widget does not exist.",
		guidance: "Refresh the widget list and use an existing ID or token.",
	},
	{
		code: "username-taken",
