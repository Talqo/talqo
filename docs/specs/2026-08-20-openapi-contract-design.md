...
Web catch handlers unpack Orval/fetch failures inline: routes surface the parsed error body message, and invitation flows additionally branch on the response status. There is no shared error module.
